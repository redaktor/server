...
exports.Flags = /\w*$/;
exports.Apos = RegExp(rsApos, 'g');
exports.Trim = /^\s+|\s+$/g;
exports.TrimStart = /^\s+/;
exports.TrimEnd = /\s+$/;
exports.ComboMark = RegExp(rsCombo, 'g');
exports.HasUnicode = RegExp('[' + rsZWJ + rsAstralRange + rsComboMarksRange + rsComboSymbolsRange + rsVarRange + ']');
exports.HasUnicodeWord = /[a-z][A-Z]|[A-Z]{2,}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/;
exports.Unicode = RegExp(rsFitz + '(?=' + rsFitz + ')|' + rsSymbol + rsSeq, 'g');
