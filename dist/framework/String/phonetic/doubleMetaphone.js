        ...
        switch (characters[index]) {
            ...
            case 'G':
                if (next === 'H') {
                    ...
                    if (((subvalue = characters[index - 2]),
                ...
                if (next === 'N') {
                    ...
                    else if (value.slice(index + 2, index + 4) !== 'EY' &&
            ...
            case 'H':
                ...
                break;
            case 'J':
                if (value.slice(index, index + 4) === 'JOSE' ||
                    value.slice(0, 4) === 'SAN ') {
                    if (value.slice(0, 4) === 'SAN ' ||
...
function doubleMetaphones(pattern) {
    return fromStringOrArray_1.default(pattern, doubleMetaphone);
}
exports.default = doubleMetaphones;
//# sourceMappingURL=doubleMetaphone.js.map