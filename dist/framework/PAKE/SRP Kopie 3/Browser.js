        ...
        Browser.send(challengePath, cData, shared, function (res) {
            ...
            Browser.send(form.action, lData, shared, (res) => {
                ...
                Browser.send(form.action, vData, shared, (res) => {
                    const _a = client.verify.call(client, res, shared, callback), { U } = _a, idData = tslib_1.__rest(_a, ["U"]);
                    console.log('sending to', U, idData);
                    Browser.send(U, idData, shared, function (res) {
