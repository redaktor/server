import { BrowserOptions, BrowserRegister, BrowserChallenge, BrowserLogin, SharedSRP, SharedChallengeResponse, SupportedRFC5054Bits } from './interfaces';
...
export declare class Browser extends Base {
    ...
    static login(form: HTMLFormElement, options?: BrowserOptions): void;
