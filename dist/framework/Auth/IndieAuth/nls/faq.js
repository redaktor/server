...
const bundlePath = ((main_1.default('host-node') ? __dirname : 'src/Auth/IndieAuth/nls') + '/faq');
const locales = ['de'];
const messages = {
    faq: 'Frequently Asked Questions',
    q1: 'How is this different from OpenID?',
    a1: main_2._ `The goals of OpenID and IndieAuth are similar. Both encourage you to sign in
    ...
    a2: main_2._ `Yes, your rel="me" links do not need to be visible, but the html does need
    ...
    a4: main_2._ `Yes, the assumption is that people are willing to
    ...
    a5: main_2._ `This service exists for websites to use if they don\'t want to implement OAuth code
    ...
    a6: main_2._ `If an application is using IndieAuth.com as an auth service and IndieAuth.com is down,
    ...
    a7: main_2._ `We gladly welcome new providers! The goal is to support as many as possible so users are not',
    ...
    a7_2: main_2._ `When displaying the HTML rendering of a user\'s page, ensure the
    ...
    a7_4: main_2._ `Integrate the new provider into the IndieAuth source codes, or just
    <a href="https://github.com/aaronpk/IndieAuth/issues/new">open an issue</a> with your request.`,
    q8: 'Why isn\'t Google+ working?',
    a8: main_2._ `Google+ profiles lost all the rel="me" attributes on links for personal pages.
    ...
    a9: main_2._ `IndieAuth.com requests the minimum permissions from each OAuth provider.
