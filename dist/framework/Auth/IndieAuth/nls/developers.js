...
const bundlePath = ((main_1.default('host-node') ? __dirname : 'src/Auth/IndieAuth/nls') + '/developers');
const locales = ['de'];
const messages = {
    ...
    intro: main_2._ `If you are building a website and need to sign people in,
    ...
    paramAction: main_2._ `<b>action</b>: Set the action of the form to your IndieAuth service
    ...
    paramClientId: main_2._ `<b>client_id</b>: Set the client_id in a hidden field to let us know
    the home page of the application the user is signing in to`,
    paramRedirectUri: main_2._ `<b>redirect_uri</b>: Set the redirect_uri in a hidden field to
    let us know where to redirect back to after authentication is complete`,
    lead1: 'The user logs in with their domain',
    text1: main_2._ `After the user enters their domain in the sign-in form and submits,
    ...
    text2: main_2._ `If everything is successful, the user will be redirected back to the redirect_uri
    ...
    text3: main_2._ `At this point you need to verify the code which will also return the domain
    ...
    lead4: 'Done!',
    text4: main_2._ `Finally you know the domain belonging to the authenticated user.
