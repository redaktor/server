...
const bundlePath = ((main_1.default('host-node') ? __dirname : 'src/Auth/IndieAuth/nls') + '/index');
const locales = ['de'];
const messages = {
    slogan: 'Be just &ldquo;you&rdquo;.',
    providers: 'Providers',
    what: 'What is IndieAuth?',
    whatText: main_2._ `IndieAuth is a way to <b>use your own domain name</b> to sign in to websites.<br />
    ...
    why: 'Why IndieAuth?',
    whyText: main_2._ `IndieAuth is part of the <a href="http://indiewebcamp.com/why">IndieWeb movement</a>
    ...
    how1: main_2._ `Add links on your home page to your social profiles<br>with the attribute
