...
const messages = {
    ...
    intro: main_1._ `Wenn Du eine Webseite baust und Leute sollen sich einloggen,
    ...
    paramAction: main_1._ `<b>action</b>: Die action der Form bestimmt der IndieAuth Service
    ...
    paramClientId: main_1._ `<b>client_id</b>: Trage die client_id in ein "hidden field" ein: Laß uns wissen,
    bei welcher Seite der Anwendung die Benutzer sich anmelden`,
    paramRedirectUri: main_1._ `<b>redirect_uri</b>: Trage die client_id in ein "hidden field" ein: Laß uns wissen,
    ...
    text1: main_1._ `Nachdem die Benutzer ihre Domain in die Sign-In Form eingegeben und übermittelt haben,
    ...
    text2: main_1._ `Wenn alles erfolgreich ist, wird der Benutzer zur redirect_uri (Form Parameter) geleitet.
    Ein Token findet sich in den Query String Parametern.`,
    lead3: 'Verifiziere den Authentifizierungs-Code mit indieauth.com',
    text3: main_1._ `An diesem Punkt angekommen musst du den Code verifizieren um die Domain des
    ...
    lead4: 'Fertig!',
    text4: main_1._ `Nun kennst Du die Domain, die der authentifizierten Person gehört.
