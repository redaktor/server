...
const messages = {
    ...
    a1: main_1._ `Die Ziele von OpenID und IndieAuth sind ähnlich. Beide ermutigen dich, beim Anmelden bei
    ...
    a2: main_1._ `Ja, deine rel="me" links müssen nicht sichtbar sein, aber das html Fragment muss sich
    ...
    a4: main_1._ `Ja &mdash; die Annahme ist, daß die Leute bereit sind, ihre
    ...
    a5: main_1._ `Dieser Service existiert für Webseitenbetreiber, die nicht eigenen OAuth code
    ...
    a6: main_1._ `Wenn eine Anwendung IndieAuth.com als Auth Service benutzt und IndieAuth.com ist nicht erreichbar,
    ...
    a7: main_1._ `Neue Provider sind sehr willkommen! Das Ziel ist es, soviele Benutzer wie möglich zu unterstützen.
    Das musst Du tun um von IndieAuth unterstützt zu werden:`,
    a7_1: main_1._ `Stelle sicher, daß deine Benutzer eine Möglichkeit haben, ihre Webseiten-Adresse in der "Profil"
    Sektion Deiner Anbieterseite zu veröffentlichen`,
    a7_2: main_1._ `Wo das HTML der Benutzer-Seite gerendert wird, stelle sicher, das ein
    ...
    a7_4: main_1._ `Integriere den neuen Provider in die IndieAuth source codes, oder öffne einfach
    ...
    a8: main_1._ `Google+ Profile haben alle rel="me" Attribute bei Links verloren.
    ...
    a9: main_1._ `IndieAuth.com fragt jeden OAuth Provider nach minimalen Erlaubnissen.
