...
const messages = {
    ...
    whatText: main_1._ `Mit IndieAuth kannst Du deinen eigenen Domainnamen nutzen um dich bei Webseiten
    anzumelden.<br />
    ...
    why: 'Warum IndieAuth?',
    whyText: main_1._ `IndieAuth ist Teil der <a href="http://indiewebcamp.com/why">IndieWeb Bewegung</a>
    ...
    how1: main_1._ `Erstelle auf Deiner Homepage Links zu deinen sozialen Profilen<br/>mit dem Attribut
    ...
    attend: 'Besuche ein',
    eventN: 'in der Nähe',
    join1: main_1._ `Trage dich in die IndieWebCamp Gästeliste ein,<br/>nachdem Du dich mit eigener Domain
    anmeldest ...`,
