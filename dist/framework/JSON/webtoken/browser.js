...
const browser_1 = require("../../crypto/browser");
...
function getAlgos(method) {
    ...
    if (algorithmMap.hasOwnProperty(uMethod)) {
        ...
        return browser_1.hmacAlgorithm(method, true);
    }
}
class jwt {
    ...
    static decode(token, key, method = 'HS256', doVerify = true) {
        ...
        const header = JSON.parse(base64_1.urlDecode(s.header));
    ...
    static sign(text, key, method = 'HS256') {
        ...
        let base64str = '';
        if (signMethod) {
            base64str = browser_1.default.sign(text, key, signMethod);
        }
        else {
            base64str = browser_1.default.hmac(text, key, 'base64', method);
        }
        return base64_1.escape(base64str);
    }
    static verify(text, key, signature, method = 'HS256') {
        ...
        if (signMethod) {
            ...
            return browser_1.default.verify(text, key, method, base64_1.unescape(signature));
        }
        else {
